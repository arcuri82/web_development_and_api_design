...
const App = () => {
  /*
        ...
        If you dont want to add a tag to your html-three you can use a React fragment.
        The full tag is <React.Fragment></React.Fragment> the short hand looks like this <></>.
